            ...
            <div className='flex items-center justify-between'>
                ...
                <aside>
                    <ul className='flex justify-center items-center gap-8'>
                        ...
                        <Link to={ROUTES.MYPOSTERORDERS}><li className='text-white cursor-pointer mx-auto hover:border-b border-white transition-all duration-75'>Мои заказы</li></Link>
                    </ul>
                </aside>
